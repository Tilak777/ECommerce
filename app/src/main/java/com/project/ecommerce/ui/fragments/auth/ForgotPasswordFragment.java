...
import com.project.ecommerce.databinding.FragmentForgotPasswordBinding;
...
public class ForgotPasswordFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnReset.setOnClickListener(view1 -> {
            Navigation.findNavController(view1).navigate(R.id.action_forgotPasswordFragment_to_resetPasswordFragment);
        });
    }
}
